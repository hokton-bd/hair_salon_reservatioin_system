                    ...
                    <form action="#" class="contact-form">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <textarea style=" border: none; font-size: 11px; resize: none; height: 160px;" class="form-control mb-3 text-white" placeholder="Message" name="message" cols="30" rows="10"></textarea>
